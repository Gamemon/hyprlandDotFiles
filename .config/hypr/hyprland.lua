...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("[workspace 2 silent] kitty --hold -e taskwarrior-tui")
    hl.exec_cmd("[workspace 3 silent] kitty --hold -e nvim")
    hl.exec_cmd("[workspace 3 silent] kitty --hold -e fetch -l arch --infinite -s 1.5 --depth 2.0 --height 40 --box")
